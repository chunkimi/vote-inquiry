        ...
        <div class="card-body p-6">
          ...
          <div class="mb-4">
            <div class="d-flex justify-content-between align-items-center">
              <p>得票率</p>
              <p>{{ percentage(candidate.voteRate) }}</p>
            </div>
            <div class="d-flex justify-content-between align-items-center">
              <p>所屬政黨</p>
              <div class="d-flex align-items-center">
          ...
          <div>
            <div class="d-flex justify-content-between align-items-center">
              ...
              <p>{{ candidate.rateAnal.cityHighest }}</p>
            </div>
            <div class="d-flex justify-content-between align-items-center">
              <p>得票率<span class="fw-bold">最低</span>地區：</p>
              <p>{{ candidate.rateAnal.cityLowest }}</p>
            </div>
          </div>
        </div>
      </div>
...
import { commaNumber, percentage, getImageUrl } from '@/utils/base'
